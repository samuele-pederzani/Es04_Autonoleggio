...
<asp:Content ID="Content2" ContentPlaceHolderID="ctpBody" runat="server">
    <div class="container form-signin ">
        ...
        <br />
        <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="form-control btn btn-lg btn-primary btn-block" OnClick="btnLogin_Click"  />
        <br /><br />
        <asp:LinkButton ID="lnkRegistrati" runat="server" class="form-control btn btn-block btn-sm btn-outline-success" OnClick="lnkRegistrati_Click">Registrati</asp:LinkButton>
        <br />
